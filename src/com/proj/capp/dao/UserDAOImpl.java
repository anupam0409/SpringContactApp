...
public class UserDAOImpl extends BaseDAO implements UserDao {
	...
	public List<User> findAll() {
		...
		// List<User> users= getJdbcTemplate().queryForObject(sql, new UserRowMapper());
	...
	public List<User> findByProperty(String propName, Object propValue) {
		String sql = "SELECT userId,password, name, phone, email, address, loginName, role, loginStatus FROM user WHERE "
				+ propName + "=?";
